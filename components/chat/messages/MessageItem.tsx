...
export default function MessageItem({
    ...
    const renderContent = () => {
        ...
        const tokenInfoParts = message.parts.filter(part => part.type === 'dynamic-tool' && typeof part.toolName === 'string' && part.toolName.endsWith('get_token_info'))
        const tokenBalancesParts = message.parts.filter(part => part.type === 'dynamic-tool' && typeof part.toolName === 'string' && part.toolName.endsWith('get_token_balances'))
        const sendErc20Parts = message.parts.filter(part => part.type === 'dynamic-tool' && typeof part.toolName === 'string' && part.toolName.endsWith('send_erc20'))
        const sendNativeParts = message.parts.filter(part => part.type === 'dynamic-tool' && typeof part.toolName === 'string' && part.toolName.endsWith('send_native'))
        const swapParts = message.parts.filter(part => part.type === 'dynamic-tool' && typeof part.toolName === 'string' && part.toolName.endsWith('swap_tokens'))
        const txHistoryParts = message.parts.filter(part => part.type === 'dynamic-tool' && typeof part.toolName === 'string' && part.toolName.endsWith('get_tx_history'))
        const txDetailsParts = message.parts.filter(part => part.type === 'dynamic-tool' && typeof part.toolName === 'string' && part.toolName.endsWith('get_tx_details'))
        const trendingTokensParts = message.parts.filter(part => part.type === 'dynamic-tool' && typeof part.toolName === 'string' && part.toolName.endsWith('get_trending_tokens'))
        const cryptoPriceParts = message.parts.filter(part => part.type === 'dynamic-tool' && typeof part.toolName === 'string' && part.toolName.endsWith('get_crypto_price'))
        const nativeBalanceParts = message.parts.filter(part => part.type === 'dynamic-tool' && typeof part.toolName === 'string' && part.toolName.endsWith('get_balance'))
        const swapQuoteParts = message.parts.filter(part => part.type === 'dynamic-tool' && typeof part.toolName === 'string' && part.toolName.endsWith('get_swap_quote'))
        const addressBookParts = message.parts.filter(part => part.type === 'dynamic-tool' && typeof part.toolName === 'string' && part.toolName.endsWith('get_address_book'))
        const userWalletsParts = message.parts.filter(part => part.type === 'dynamic-tool' && typeof part.toolName === 'string' && part.toolName.endsWith('get_user_wallets'))
